...
const WHATS_NEW_DATA = {
    '4.1.0': {
        version: '4.1.0',
        title: 'Melhorias de UX e Novas Funcionalidades',
        features: [
            {
                type: 'new',
                icon: '📱',
                title: 'Gestos no Celular (Swipe)',
                description: 'Deslize as transações para o lado no celular: direita para marcar como paga, esquerda para excluir. Muito mais rápido!'
            },
            {
                type: 'new',
                icon: '⚡',
                title: 'Menu de Ações Rápidas (FAB)',
                description: 'O botão "+" agora expande em 3 opções: Nova Despesa, Nova Receita e Transferência entre contas. Acesso direto ao que você precisa!'
            },
            {
                type: 'new',
                icon: '📊',
                title: 'Orçamento por Categoria',
                description: 'Novo menu que mostra barras de progresso comparando seus gastos com a média dos últimos 3 meses. Cores indicam se você está dentro, perto ou acima da média.'
            },
            {
                type: 'new',
                icon: '🔄',
                title: 'Transferência entre Contas',
                description: 'Mova saldo entre suas contas de forma rápida e automática. O sistema cria as transações de entrada e saída automaticamente!'
            },
            {
                type: 'improved',
                icon: '🎨',
                title: 'Visual Aprimorado',
                description: 'Modais de menu (info e principal) com opacidade aumentada para melhor legibilidade. Disclaimer com layout otimizado e scroll suave.'
            },
            {
                type: 'improved',
                icon: '📈',
                title: 'Investimentos Sincronizados',
                description: 'Aplicações agora se vinculam automaticamente às contas de investimento, atualizando o saldo unificado em tempo real.'
            },
            {
                type: 'fixed',
                icon: '🐛',
                title: 'Correções de Bugs',
                description: 'Botão Salvar do modal de edição, timestamps nos arquivos exportados e impressão do Manual do Usuário.'
            }
        ]
    }
};
...
const manualHTML = '<div class="manual-cover">' +
    ...
    '<p class="version">Versão 4.1.0 - 2026</p>' +
    ...
    '<h3>📊 Dashboard Financeiro Inteligente</h3>' +
    ...
    '<p>O botão flutuante "+" no canto inferior direito agora é um <strong>menu de ações rápidas</strong>:</p>' +
    '<ul>' +
    '<li><strong>💸 Despesa:</strong> Abre o modal já com o tipo "Despesa" selecionado</li>' +
    '<li><strong>💰 Receita:</strong> Abre o modal já com o tipo "Receita" selecionado</li>' +
    '<li><strong>🔄 Transferência:</strong> Move saldo entre suas contas de forma rápida</li>' +
    '</ul>' +
    '<div class="manual-tip">' +
    '<strong>💡 Dica:</strong> Use a transferência para mover dinheiro da conta corrente para a conta de investimento no mesmo dia que receber seu salário. Assim você "paga a si mesmo primeiro"!' +
    '</div>' +
...
'<li><strong> Navegue entre faturas</strong> usando as setas ← → para consultar períodos anteriores ou futuros</li>' +
'<li>O período da fatura é calculado automaticamente: do fechamento anterior até o fechamento atual</li>' +
'<li>O vencimento só avança para o mês seguinte quando a fatura efetivamente fecha</li>' +
'<li>Exporte faturas em CSV ou PDF</li>' +
'</ul>' +
'<div class="manual-tip">' +
'<strong>💡 Dica de Coach:</strong> Use as setas de navegação no modal de fatura para revisar gastos de meses anteriores. Isso ajuda a identificar padrões de consumo e planejar melhor o orçamento futuro!' +
'</div>' +
    ...
    '</div>' +
    '<h3>📈 Aplicações</h3>' +
    '<p>Acompanhe todos os seus investimentos em um só lugar:</p>' +
    '<ul>' +
    '<li>Cadastre CDBs, Tesouro Direto, LCI/LCA, FIIs, Ações e mais</li>' +
    '<li>Vincule aplicações às suas contas de investimento</li>' +
    '<li>Atualize valores periodicamente para acompanhar rendimentos</li>' +
    '<li>Visualize gráficos de evolução dos seus investimentos</li>' +
    '<li>Veja o rendimento total em porcentagem e valor</li>' +
    '</ul>' +
    '<div class="manual-success">' +
    '<strong>🎯 Dica de Ouro:</strong> Atualize o valor atual dos seus investimentos pelo menos uma vez por mês. Isso te dá uma visão real do seu patrimônio e motiva a continuar investindo!' +
    '</div>' +
    '<h3>📊 Orçamento por Categoria</h3>' +
    '<p>Acesse pelo Menu → "Orçamento por Categoria" e veja:</p>' +
    '<ul>' +
    '<li>Barras de progresso comparando seus gastos com a <strong>média dos últimos 3 meses</strong></li>' +
    '<li>Cores indicativas: <strong style="color:#10b981;">verde</strong> (dentro da média), <strong style="color:#f59e0b;">amarelo</strong> (próximo ao limite) e <strong style="color:#ef4444;">vermelho</strong> (acima da média)</li>' +
    '<li>Indicadores ⬆️ ⬇️ mostrando se você gastou mais ou menos que a média</li>' +
    '<li>Valor exato da diferença em relação à média histórica</li>' +
    '</ul>' +
    '<div class="manual-tip">' +
    '<strong>💡 Como usar:</strong> Se você gastou 120% da média em "Lazer" este mês, a barra ficará vermelha e mostrará quanto você gastou a mais. Isso te ajuda a identificar categorias que precisam de atenção!' +
    '</div>' +
    '<h3>📱 Gestos no Celular (Swipe)</h3>' +
    '<p>No celular, você pode usar gestos de deslizar nas transações:</p>' +
    '<ul>' +
    '<li><strong>Deslize para a direita:</strong> Marca a transação como "Concluída/Paga"</li>' +
    '<li><strong>Deslize para a esquerda:</strong> Abre opção para excluir a transação</li>' +
    '</ul>' +
    '<div class="manual-tip">' +
    '<strong>⚡ Dica Rápida:</strong> Os gestos funcionam apenas no mobile e economizam vários cliques! Perfeito para marcar contas como pagas rapidamente.' +
    '</div>' +
    '<h3> Alertas de Contas & Fechamento</h3>' +
    '<p>Nunca mais esqueça uma conta! O sistema avisa automaticamente:</p>' +
    '<ul>' +
    '<li><strong>Contas a vencer:</strong> Pendências dos próximos 3 dias</li>' +
    '<li><strong>🆕 Fechamento de fatura:</strong> Alerta especial 1 dia antes do fechamento do seu cartão</li>' +
    '</ul>' +
    '<div class="manual-tip">' +
    '<strong>💡 Dica de Coach:</strong> Quando receber o alerta "O cartão X fecha amanhã!", revise suas compras pendentes. É o momento ideal para decidir o que pode ser adiado para a próxima fatura e evitar surpresas no vencimento!' +
    '</div>' +
    '<h3>📊 Gráficos, Análises e Impressão</h3>' +
    '<p>Visualize seus dados de forma clara:</p>' +
    '<ul>' +
    '<li><strong>Entradas e Saídas:</strong> Evolução mensal dos últimos 6 meses</li>' +
    '<li><strong>Despesas por Categoria:</strong> Onde seu dinheiro está indo</li>' +
    '<li><strong>Cartões de Crédito:</strong> Evolução dos gastos por cartão</li>' +
    '<li><strong>Investimentos:</strong> Evolução do patrimônio ao longo do tempo</li>' +
    '</ul>' +
    '<div class="manual-tip">' +
    '<strong>🖨️ Impressão Simplificada:</strong> Ao imprimir o extrato, as colunas de Pagamento e Categoria aparecem de forma limpa (sem ícones e cores), facilitando a leitura em papel e economizando tinta!' +
    '</div>' +
    ...
    '</ul>' +
    '<div class="manual-tip">' +
    '<strong>💡 Como aplicar no Smart Wallet:</strong> Use o menu "Orçamento por Categoria" para verificar se seus gastos estão seguindo a proporção ideal. Se "Desejos" estiver acima de 30%, é hora de ajustar!' +
    '</div>' +
    ...
    '<li><strong>FIIs:</strong> Fundos Imobiliários - recebem aluguéis mensais isentos de IR</li>' +
    '</ul>' +
    '<div class="manual-tip">' +
    ...
    '</div>' +
    '<div class="manual-success">' +
    '<strong>🎯 No Smart Wallet:</strong> Use o menu "Aplicações" para cadastrar seus investimentos. Vincule-os às suas contas de investimento para sincronização automática do saldo!' +
    '</div>' +
    ...
    '</ul>' +
    '<h3>🎯 Dicas do Coach SW</h3>' +
    '<p>O Smart Wallet não é apenas uma ferramenta de registro — é seu coach financeiro pessoal. Aqui estão dicas exclusivas para maximizar seus resultados:</p>' +
    '<div class="manual-success">' +
    '<strong> Dica #1 - Navegação de Faturas:</strong><br>' +
    'Use as setas no modal de fatura para revisar meses anteriores. Identifique em quais meses você gastou mais e tente entender o motivo. Foi um evento especial? Compras impulsivas? Essa análise é o primeiro passo para melhorar.' +
    '</div>' +
    '<div class="manual-success">' +
    '<strong>💡 Dica #2 - Alerta de Fechamento:</strong><br>' +
    'Quando o app avisar "O cartão X fecha amanhã!", faça uma revisão rápida: você tem compras grandes pendentes? Pode adiar alguma para o próximo ciclo? Essa pequena ação evita que você estoure o limite ou pague juros desnecessários.' +
    '</div>' +
    '<div class="manual-success">' +
    '<strong>💡 Dica #3 - Impressão para Análise:</strong><br>' +
    'Imprima seu extrato mensal e marque com caneta os gastos que poderiam ter sido evitados. Esse exercício visual é poderoso para criar consciência financeira. Guarde os extratos impressos em uma pasta — em 6 meses, você terá um histórico tangível da sua evolução!' +
    '</div>' +
    '<div class="manual-success">' +
    '<strong>💡 Dica #4 - Regra dos 3 Dias:</strong><br>' +
    'Antes de fazer uma compra acima de R$ 200, espere 3 dias. Se depois desse período você ainda sentir que precisa daquilo, provavelmente é uma compra consciente. Se esquecer, era impulso!' +
    '</div>' +
    '<div class="manual-success">' +
    '<strong> Dica #5 - Revisão Semanal:</strong><br>' +
    'Tire 15 minutos todo domingo para revisar seus gastos da semana no Smart Wallet. Esse hábito simples reduz em até 30% os gastos por impulso, segundo estudos de comportamento financeiro.' +
    '</div>' +
    ...
    '<li>Configure suas contas e cartões no app</li>' +
    '</ol>' +
    '<h3>Semana 2: Organização</h3>' +
    '<ol>' +
    '<li>Cadastre suas aplicações de investimento</li>' +
    '<li>Defina sua meta de reserva de emergência</li>' +
    '<li>Configure alertas para contas importantes</li>' +
    '<li>Faça backup dos seus dados (Menu → Backup JSON)</li>' +
    '</ol>' +
    '<h3>Semana 3: Planejamento</h3>' +
    '<ol>' +
    '<li>Aplique a regra 50-30-20 ao seu orçamento</li>' +
    '<li>Use "Orçamento por Categoria" para identificar desvios</li>' +
    ...
    '<li>Use o botão "+" para ações rápidas (Despesa/Receita/Transferência)</li>' +
    '<li>No celular, use gestos de swipe para marcar contas como pagas</li>' +
    ...
    '<p>Seus dados são preciosos. Proteja-os:</p>' +
    '<ul>' +
    '<li><strong>Backup Regular:</strong> Exporte JSON mensalmente (Menu → Backup JSON)</li>' +
    '<li><strong>Armazenamento Seguro:</strong> Salve backups em nuvem (Google Drive, Dropbox) ou e-mail</li>' +
    '<li><strong>Modo Privacidade:</strong> Ative o ícone 👁️ para ocultar valores em público</li>' +
    '<li><strong>100% Offline:</strong> Seus dados nunca saem do seu dispositivo</li>' +
    '</ul>' +
    '<div class="manual-warning">' +
    '<strong>⚠️ Importante:</strong> Se você limpar os dados do navegador ou trocar de dispositivo, perderá tudo. Por isso, faça backups regulares!' +
    '</div>' +
    '<h2>🥷 Ajuda & Suporte</h2>' +
    '<p>Se tiver dúvidas ou sugestões, entre em contato:</p>' +
    '<ul>' +
    '<li><strong>E-mail:</strong> rogerelizar@gmail.com</li>' +
    '<li><strong>Feedback:</strong> Use o botão "Apoie o Projeto" no menu (ícone ℹ️)</li>' +
    '<li><strong>Atualizações:</strong> O app atualiza automaticamente via PWA</li>' +
    '</ul>' +
	...
	this.checkVersionUpdate();	
        ...
        getMonthTransactions(date) {
            ...
            if (!date || !(date instanceof Date) || isNaN(date.getTime())) { date = new Date(); date.setDate(1); date.setHours(0, 0, 0, 0); this.currentMonth = date; }
            ...
            const result = this.transactions.filter(t => { const d = new Date(t.date + 'T12:00:00'); return d.getMonth() === m && d.getFullYear() === y; });
            this._cache.monthTransactions[key] = result;
            return result;
        }
        getCardTransactions(cardId, date) { if (!date) date = this.currentMonth; const m = date.getMonth(), y = date.getFullYear(); return this.transactions.filter(t => { if (t.paymentMethod !== 'card:' + cardId || t.amount >= 0) return false; const d = new Date(t.date + 'T12:00:00'); return d.getMonth() === m && d.getFullYear() === y; }); }
        getCardTransactionsForPeriod(cardId, startDate, closingDate) { const start = new Date(startDate); start.setHours(0, 0, 0, 0); const end = new Date(closingDate); end.setHours(23, 59, 59, 999); return this.transactions.filter(t => { if (t.paymentMethod !== 'card:' + cardId) return false; if (t.amount >= 0) return false; const tDate = new Date(t.date + 'T12:00:00'); return tDate >= start && tDate <= end; }); }
        populateCategorySelects() { const self = this; ['category', 'editCategory', 'categoryFilter'].forEach((id, i) => { const sel = document.getElementById(id); if (!sel) return; const val = sel.value; sel.innerHTML = i === 2 ? '<option value="">Todas as categorias</option>' : '<option value="">Selecione uma categoria...</option>'; self.categories.forEach(cat => { const opt = document.createElement('option'); opt.value = cat.id; opt.textContent = cat.name; opt.dataset.type = cat.type; sel.appendChild(opt); }); sel.value = val; }); this.filterCategoriesByType('category', this.currentTransactionType); const typeFilter = document.getElementById('typeFilter'); if (typeFilter) this.filterCategoriesByType('categoryFilter', typeFilter.value); }
        populatePaymentMethodSelects() { const self = this; ['paymentMethod', 'editPaymentMethod'].forEach(id => { const sel = document.getElementById(id); if (!sel) return; const currentVal = sel.value; sel.innerHTML = '<option value="">Selecione...</option>'; const group = document.createElement('optgroup'); group.label = '💰 Formas de Pagamento'; PAYMENT_METHODS.forEach(pm => { const opt = document.createElement('option'); opt.value = pm.id; opt.textContent = pm.icon + ' ' + pm.name; group.appendChild(opt); }); sel.appendChild(group); if (self.cards.length > 0) { const cardGroup = document.createElement('optgroup'); cardGroup.label = '💳 Cartões de Crédito'; self.cards.forEach(card => { const opt = document.createElement('option'); opt.value = 'card:' + card.id; opt.textContent = ' ' + card.name + ' •••• ' + (card.last4 || '****'); cardGroup.appendChild(opt); }); sel.appendChild(cardGroup); } sel.value = currentVal; }); }
        populateAccountSelects() { const self = this; ['transactionAccount', 'editTransactionAccount', 'accountFilter', 'transferFrom', 'transferTo'].forEach(id => { const sel = document.getElementById(id); if (!sel) return; const val = sel.value; const isFilter = id === 'accountFilter'; const isTransfer = id === 'transferFrom' || id === 'transferTo'; sel.innerHTML = isFilter ? '<option value="">Todas as contas</option>' : '<option value="">Selecione a conta...</option>'; self.accounts.forEach(acc => { const opt = document.createElement('option'); opt.value = acc.id; opt.textContent = (acc.type === 'checking' ? '💳 ' : '📈 ') + acc.name; sel.appendChild(opt); }); sel.value = val; }); }
        filterCategoriesByType(selectId, type) { const sel = document.getElementById(selectId); if (!sel) return; sel.querySelectorAll('option').forEach(opt => { if (opt.value === '') opt.style.display = 'block'; else opt.style.display = (!type || opt.dataset.type === type) ? 'block' : 'none'; }); const currentVal = sel.value; if (currentVal) { const currentOpt = sel.querySelector('option[value="' + currentVal + '"]'); if (currentOpt && currentOpt.style.display === 'none') sel.value = ''; } }
        getCategoryById(id) { for (let i = 0; i < this.categories.length; i++) { if (this.categories[i].id === id) return this.categories[i]; } return { name: 'Sem categoria', color: '#6b7280', type: 'expense' }; }
        findCategoryByName(name) { const lower = name.toLowerCase(); for (let i = 0; i < this.categories.length; i++) { if (this.categories[i].name.toLowerCase() === lower) return this.categories[i]; } return null; }
        getCardById(id) { for (let i = 0; i < this.cards.length; i++) { if (this.cards[i].id === id) return this.cards[i]; } return null; }
        getPaymentMethodName(method) { if (!method) return '-'; if (method.indexOf('card:') === 0) { const card = this.getCardById(method.replace('card:', '')); return card ? '💳 ' + card.name : 'Cartão removido'; } for (let i = 0; i < PAYMENT_METHODS.length; i++) { if (PAYMENT_METHODS[i].id === method) return PAYMENT_METHODS[i].icon + ' ' + PAYMENT_METHODS[i].name; } return method; }
        ...
        updateDashboard() {
            ...
            this.investments.forEach(inv => { if (!inv.accountId) unifiedBalance += inv.current; });
            let creditCardTotal = 0;
            const self = this;
            this.cards.forEach(card => { const cardTrans = self.getCardTransactions(card.id); cardTrans.forEach(t => { creditCardTotal += Math.abs(t.amount); }); });
        ...
        render() {
            ...
            sorted.forEach(t => {
                ...
                let rowHtml = '<td data-label="Data">' + self.formatDate(t.date) + '</td><td data-label="Descrição">' + self.escapeHtml(t.description || '-') + '</td><td data-label="Categoria"><span class="category-badge" style="background:' + cat.color + '">' + self.escapeHtml(cat.name) + '</span></td><td data-label="Conta">' + (acc ? '<span class="account-badge">' + self.escapeHtml(acc.name) + '</span>' : '-') + '</td><td data-label="Pagamento"><span class="payment-badge">' + paymentName + '</span></td><td data-label="Status"><span class="status-badge ' + statusClass + '">' + statusText + '</span></td><td data-label="Recorrência">' + (recurrenceHtml || '-') + '</td><td data-label="Valor" class="amount ' + cls + ' privacy-value">' + self.formatCurrency(t.amount) + '</td><td data-label="Saldo" class="balance privacy-value">' + self.formatCurrency(balMap[t.id]) + '</td>';
                if (isMobile) {
                    rowHtml = '<div class="swipe-actions"><div class="swipe-action complete">✓ Paga</div><div class="swipe-action delete">🗑️ Excluir</div></div>' + rowHtml;
                }
        ...
        getFilteredTransactions() { const search = (document.getElementById('searchFilter').value || '').toLowerCase(); const catFilter = document.getElementById('categoryFilter').value; const typeFilter = document.getElementById('typeFilter').value; const statusFilter = document.getElementById('statusFilter').value; const accountFilter = document.getElementById('accountFilter').value; const self = this; return this.getMonthTransactions().filter(t => { const cat = self.getCategoryById(t.category); const matchSearch = !search || (t.description || '').toLowerCase().indexOf(search) !== -1 || cat.name.toLowerCase().indexOf(search) !== -1; const matchCat = !catFilter || t.category === catFilter; const matchType = !typeFilter || (typeFilter === 'income' ? t.amount > 0 : t.amount < 0); const matchStatus = !statusFilter || (statusFilter === 'done' ? t.statusOk : !t.statusOk); const matchAccount = !accountFilter || t.accountId === accountFilter; return matchSearch && matchCat && matchType && matchStatus && matchAccount; }); }
        generateUniqueId() { if (window.crypto && crypto.randomUUID) { return crypto.randomUUID(); } return Date.now().toString(36) + Math.random().toString(36).substr(2, 9); }
        addTransaction() { const date = document.getElementById('date').value; const amount = parseFloat(document.getElementById('amount').value); const category = document.getElementById('category').value; const description = document.getElementById('description').value; const statusOk = document.getElementById('statusOk').checked; const paymentMethod = document.getElementById('paymentMethod').value; const accountId = document.getElementById('transactionAccount').value; const isRecurring = document.getElementById('recurring').checked; if (!category) { this.showToast('Selecione uma categoria'); return; } if (!paymentMethod) { this.showToast('Selecione a forma de pagamento'); return; } if (!date) { this.showToast('Selecione uma data'); return; } if (isNaN(amount) || amount <= 0) { this.showToast('Valor inválido'); return; } if (isRecurring) { const recurrenceType = document.getElementById('recurrenceType').value; const recurrenceCount = parseInt(document.getElementById('recurrenceCount').value); if (recurrenceCount < 2) { this.showToast('Mínimo de 2 parcelas'); return; } const startDate = new Date(date + 'T12:00:00'); const baseAmount = this.currentTransactionType === 'expense' ? -Math.abs(amount) : Math.abs(amount); const recurrenceGroupId = this.generateUniqueId(); let createdCount = 0; for (let i = 0; i < recurrenceCount; i++) { const transDate = new Date(startDate); if (recurrenceType === 'monthly' || recurrenceType === 'installment') { transDate.setMonth(startDate.getMonth() + i); const lastDay = new Date(transDate.getFullYear(), transDate.getMonth() + 1, 0).getDate(); transDate.setDate(startDate.getDate() > lastDay ? lastDay : startDate.getDate()); } else if (recurrenceType === 'yearly') { transDate.setFullYear(startDate.getFullYear() + i); const lastDay = new Date(transDate.getFullYear(), transDate.getMonth() + 1, 0).getDate(); transDate.setDate(startDate.getDate() > lastDay ? lastDay : startDate.getDate()); } let transDescription = description; if (recurrenceType === 'installment') transDescription = description + ' - Parcela ' + (i + 1) + '/' + recurrenceCount; const uniqueId = this.generateUniqueId() + '_' + i; this.transactions.push({ id: uniqueId, date: transDate.toISOString().split('T')[0], amount: baseAmount, category: category, description: transDescription, statusOk: statusOk, paymentMethod: paymentMethod, accountId: accountId, recurrence: { groupId: recurrenceGroupId, type: recurrenceType, total: recurrenceCount, current: i + 1 } }); createdCount++; } this.clearCache(); this.saveTransactions(); this.render(); this.updateCharts(); this.updateAlertBadge(); this.showToast('✅ ' + createdCount + ' transações recorrentes criadas!'); closeNewTransactionModal(); this.clearForm(); return; } const transaction = { id: this.generateUniqueId(), date: date, amount: this.currentTransactionType === 'expense' ? -Math.abs(amount) : Math.abs(amount), category: category, description: description, statusOk: statusOk, paymentMethod: paymentMethod, accountId: accountId }; this.clearCache(); this.transactions.push(transaction); this.saveTransactions(); this.render(); this.updateCharts(); this.updateAlertBadge(); this.showToast('Transação adicionada!'); closeNewTransactionModal(); this.clearForm(); }
        clearForm() { const form = document.getElementById('transactionForm'); if (form) form.reset(); this.setDefaultDate(); this.currentTransactionType = 'expense'; document.querySelectorAll('#transactionForm .type-btn').forEach(b => b.classList.toggle('active', b.getAttribute('data-type') === 'expense')); this.filterCategoriesByType('category', 'expense'); const recurringOptions = document.getElementById('recurringOptions'); if (recurringOptions) recurringOptions.style.display = 'none'; }
        editTransaction(id) { let t = null; for (let i = 0; i < this.transactions.length; i++) { if (this.transactions[i].id === id) { t = this.transactions[i]; break; } } if (!t) return; this.currentEditId = id; this.currentEditType = t.amount > 0 ? 'income' : 'expense'; document.getElementById('editId').value = t.id; document.getElementById('editDate').value = t.date; document.getElementById('editAmount').value = Math.abs(t.amount); document.getElementById('editCategory').value = t.category || ''; document.getElementById('editPaymentMethod').value = t.paymentMethod || ''; document.getElementById('editTransactionAccount').value = t.accountId || ''; document.getElementById('editDescription').value = t.description || ''; document.getElementById('editStatusOk').checked = !!t.statusOk; if (t.recurrence) { document.getElementById('editRecurring').checked = true; document.getElementById('editRecurringOptions').style.display = 'block'; document.getElementById('editRecurrenceType').value = t.recurrence.type; document.getElementById('editRecurrenceCount').value = t.recurrence.total; } else { document.getElementById('editRecurring').checked = false; document.getElementById('editRecurringOptions').style.display = 'none'; } document.querySelectorAll('#editForm .type-btn').forEach(b => b.classList.toggle('active', b.getAttribute('data-type') === this.currentEditType)); this.filterCategoriesByType('editCategory', this.currentEditType); document.getElementById('editModal').classList.add('active'); }
        updateTransaction() { const id = document.getElementById('editId').value; const date = document.getElementById('editDate').value; const amount = parseFloat(document.getElementById('editAmount').value); const category = document.getElementById('editCategory').value; const paymentMethod = document.getElementById('editPaymentMethod').value; if (!id) { this.showToast('❌ Erro: ID não encontrado'); return; } if (!date) { this.showToast('⚠️ Selecione uma data'); return; } if (isNaN(amount) || amount <= 0) { this.showToast('⚠️ Valor inválido'); return; } if (!category) { this.showToast('⚠️ Selecione uma categoria'); return; } if (!paymentMethod) { this.showToast('️ Selecione a forma de pagamento'); return; } let idx = -1; for (let i = 0; i < this.transactions.length; i++) { if (String(this.transactions[i].id) === String(id)) { idx = i; break; } } if (idx === -1) { this.showToast('❌ Transação não encontrada'); return; } const isRecurring = document.getElementById('editRecurring').checked; let recurrenceData = null; if (isRecurring) { const recurrenceType = document.getElementById('editRecurrenceType').value; const recurrenceCount = parseInt(document.getElementById('editRecurrenceCount').value); recurrenceData = { type: recurrenceType, total: recurrenceCount, current: this.transactions[idx].recurrence ? this.transactions[idx].recurrence.current : 1 }; } this.transactions[idx] = { id: this.transactions[idx].id, date: date, amount: this.currentEditType === 'expense' ? -Math.abs(amount) : Math.abs(amount), category: category, description: document.getElementById('editDescription').value, statusOk: document.getElementById('editStatusOk').checked, paymentMethod: paymentMethod, accountId: document.getElementById('editTransactionAccount').value, recurrence: recurrenceData }; this.clearCache(); this.saveTransactions(); this.render(); this.updateCharts(); this.updateAlertBadge(); closeEditModal(); this.showToast('✅ Transação atualizada!'); }
        ...
        applyTheme() { document.body.classList.toggle('light', !this.darkMode); const btn = document.getElementById('themeBtn'); if (btn) { btn.innerHTML = this.darkMode ? '<svg class="icon" viewBox="0 0 24 24"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>' : '<svg class="icon" viewBox="0 0 24 24"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>'; } if (Object.keys(this.charts).length > 0) { try { this.updateChartsTheme(); } catch (e) { console.warn('[SmartWallet] Erro tema:', e); } } }
        applyPrivacy() { document.body.classList.toggle('privacy-on', this.privacyOn); const btn = document.getElementById('privacyBtn'); if (btn) { btn.innerHTML = this.privacyOn ? '<svg class="icon" viewBox="0 0 24 24"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>' : '<svg class="icon" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>'; btn.classList.toggle('active', this.privacyOn); } }
        ...
        initCharts() { if (typeof Chart === 'undefined') { console.error('[SmartWallet] Chart.js não carregado!'); return; } const colors = this.getChartColors(); const lineOpts = { responsive: true, maintainAspectRatio: false, plugins: { legend: { position: 'top', labels: { color: colors.text } } }, scales: { y: { beginAtZero: true, ticks: { color: colors.textSecondary }, grid: { color: colors.grid } }, x: { ticks: { color: colors.textSecondary }, grid: { color: colors.grid } } } }; try { this.charts.line = new Chart(document.getElementById('lineChart').getContext('2d'), { type: 'line', data: { labels: [], datasets: [ { label: 'Receitas', data: [], borderColor: '#10b981', backgroundColor: 'rgba(16,185,129,0.1)', tension: 0.4 }, { label: 'Despesas', data: [], borderColor: '#ef4444', backgroundColor: 'rgba(239,68,68,0.1)', tension: 0.4 } ] }, options: lineOpts }); } catch (e) { console.error('[SmartWallet] Erro line:', e); } try { this.charts.pie = new Chart(document.getElementById('pieChart').getContext('2d'), { type: 'bar', data: { labels: [], datasets: [{ data: [], backgroundColor: [] }] }, options: { indexAxis: 'y', responsive: true, maintainAspectRatio: false, plugins: { legend: { display: false } }, scales: { x: { beginAtZero: true, ticks: { color: colors.textSecondary }, grid: { color: colors.grid } }, y: { ticks: { color: colors.textSecondary }, grid: { color: colors.grid } } }, barPercentage: 0.3, categoryPercentage: 0.5 } }); } catch (e) { console.error('[SmartWallet] Erro pie:', e); } try { this.charts.cards = new Chart(document.getElementById('cardsChart').getContext('2d'), { type: 'line', data: { labels: [], datasets: [] }, options: { responsive: true, maintainAspectRatio: false, plugins: { legend: { position: 'top', labels: { color: colors.text } } }, scales: { y: { beginAtZero: true, ticks: { color: colors.textSecondary }, grid: { color: colors.grid } }, x: { ticks: { color: colors.textSecondary }, grid: { color: colors.grid } } } } }); } catch (e) { console.error('[SmartWallet] Erro cards:', e); } this.updateCharts(); }
        updateChartsTheme() { const colors = this.getChartColors(); const self = this; Object.keys(this.charts).forEach(key => { const chart = self.charts[key]; if (!chart || !chart.options) return; try { if (chart.options.scales?.y?.ticks) chart.options.scales.y.ticks.color = colors.textSecondary; if (chart.options.scales?.y?.grid) chart.options.scales.y.grid.color = colors.grid; if (chart.options.scales?.x?.ticks) chart.options.scales.x.ticks.color = colors.textSecondary; if (chart.options.scales?.x?.grid) chart.options.scales.x.grid.color = colors.grid; if (chart.options.plugins?.legend?.labels) chart.options.plugins.legend.labels.color = colors.text; chart.update('none'); } catch (e) { console.warn('[SmartWallet] Erro tema gráfico:', e); } }); }
        updateCharts() { const self = this; const lLabels = [], lInc = [], lExp = []; for (let i = -2; i <= 3; i++) { const d = new Date(this.currentMonth); d.setMonth(d.getMonth() + i); const months = ['Jan','Fev','Mar','Abr','Mai','Jun','Jul','Ago','Set','Out','Nov','Dez']; lLabels.push(months[d.getMonth()] + '/' + d.getFullYear()); const mt = this.getMonthTransactions(d); let inc = 0, exp = 0; mt.forEach(t => { if (t.amount > 0) inc += t.amount; else exp += t.amount; }); lInc.push(inc); lExp.push(Math.abs(exp)); } if (this.charts.line) { this.charts.line.data.labels = lLabels; this.charts.line.data.datasets[0].data = lInc; this.charts.line.data.datasets[1].data = lExp; this.charts.line.update(); } const exps = {}; this.getMonthTransactions().forEach(t => { if (t.amount < 0) { const c = self.getCategoryById(t.category); if (!exps[c.name]) exps[c.name] = { t: 0, color: c.color }; exps[c.name].t += Math.abs(t.amount); } }); if (this.charts.pie) { this.charts.pie.data.labels = Object.keys(exps); this.charts.pie.data.datasets[0].data = Object.keys(exps).map(k => exps[k].t); this.charts.pie.data.datasets[0].backgroundColor = Object.keys(exps).map(k => exps[k].color); this.charts.pie.update(); } if (this.charts.cards) { const cardLabels = []; const cardDatasets = []; for (let i = -2; i <= 3; i++) { const d = new Date(this.currentMonth); d.setMonth(d.getMonth() + i); const months = ['Jan','Fev','Mar','Abr','Mai','Jun','Jul','Ago','Set','Out','Nov','Dez']; cardLabels.push(months[d.getMonth()] + '/' + d.getFullYear()); } this.cards.forEach(card => { const data = []; for (let i = -2; i <= 3; i++) { const d = new Date(self.currentMonth); d.setMonth(d.getMonth() + i); const cardTrans = self.getCardTransactions(card.id, d); let total = 0; cardTrans.forEach(t => total += Math.abs(t.amount)); data.push(total); } cardDatasets.push({ label: card.name, data: data, borderColor: card.color, backgroundColor: card.color + '20', tension: 0.4, fill: false }); }); this.charts.cards.data.labels = cardLabels; this.charts.cards.data.datasets = cardDatasets; this.charts.cards.update(); } this.updateInvestmentChart(); }
updateAlertBadge() { const today = new Date(); today.setHours(0, 0, 0, 0); const in3Days = new Date(today); in3Days.setDate(in3Days.getDate() + 3); const self = this; const bills = this.transactions.filter(t => { if (t.statusOk || t.amount >= 0) return false; const tDate = new Date(t.date + 'T12:00:00'); return tDate <= in3Days; }); const badge = document.getElementById('alertBadge'); const btn = document.getElementById('alertBtn'); if (badge && btn) { if (bills.length > 0) { badge.textContent = bills.length; badge.classList.add('visible'); btn.classList.add('has-alerts'); } else { badge.classList.remove('visible'); btn.classList.remove('has-alerts'); } } }
...
checkVersionUpdate() {
    ...
    try {
        ...
        if (lastVersion !== CURRENT_VERSION) {
            // Versão mudou - mostrar novidades
            this.showWhatsNewModal(CURRENT_VERSION);
            localStorage.setItem(STORAGE_KEY, CURRENT_VERSION);
        }
    } catch (e) {
        console.warn('[SmartWallet] Erro ao verificar versão:', e);
    }
}
...
showWhatsNewModal(version) {
    ...
    document.getElementById('whatsNewVersion').textContent = data.version;
    ...
    data.features.forEach(feature => {
        ...
        html += '<div class="feature-item ' + feature.type + '">' +
            '<div class="feature-icon">' + feature.icon + '</div>' +
            '<div class="feature-content">' +
            '<h4>' + this.escapeHtml(feature.title) + ' <span class="feature-badge ' + feature.type + '">' + badgeText + '</span></h4>' +
    ...
    // Data de fechamento da fatura ANTERIOR (início do período)
    const previousClosingDate = new Date(closingDate);
    previousClosingDate.setMonth(previousClosingDate.getMonth() - 1);
    previousClosingDate.setDate(previousClosingDate.getDate() + 1); // Dia seguinte ao fechamento
    
    // Data de vencimento: só muda para mês seguinte quando fatura fechar
    const today = new Date();
    today.setHours(0, 0, 0, 0);
    const isClosed = closingDate < today; // Fatura já fechou
    
    let dueDate = new Date(closingDate);
    if (isClosed) {
        // Fatura fechou, vencimento é no mês seguinte
    ...
    return { 
        ...
        renderCreditCardsList() { const container = document.getElementById('creditCardsList'); if (!container) return; window.updateCardMonthLabel(); if (!this.cards.length) { container.innerHTML = '<div style="text-align:center; padding:40px 20px; color:var(--text-secondary);"><div style="font-size:3rem; margin-bottom:12px; opacity:0.5;">💳</div><h3>Nenhum cartão cadastrado</h3><p>Clique em "Novo Cartão" para começar</p></div>'; return; } const self = this; const refDate = this.cardModalMonth; let html = '<div class="credit-cards-grid">'; this.cards.forEach(card => { const period = self.getInvoicePeriod(card, refDate); const purchases = self.getCardTransactionsForPeriod(card.id, period.startDate, period.closingDate); const total = self.calculateInvoiceTotal(purchases); const available = card.limit - total; const usedPct = Math.min(100, (total / card.limit) * 100); html += '<div class="credit-card-visual" style="background:linear-gradient(135deg, ' + card.color + ' 0%, ' + self.adjustColor(card.color, -30) + ' 100%);" onclick="openInvoiceModal(\'' + card.id + '\')">'; html += '<div class="cc-actions"><button class="cc-action-btn" onclick="event.stopPropagation(); smartwallet.editCard(\'' + card.id + '\')">✏️</button><button class="cc-action-btn" onclick="event.stopPropagation(); smartwallet.deleteCard(\'' + card.id + '\')">️</button></div>'; html += '<div class="cc-header"><div class="cc-brand">' + self.escapeHtml(card.brand) + '</div><div class="cc-chip"></div></div>'; html += '<div class="cc-name">' + self.escapeHtml(card.name) + '</div>'; html += '<div class="cc-number">•••• •••• •••• ' + self.escapeHtml(card.last4 || '****') + '</div>'; html += '<div class="cc-footer"><div><div class="cc-label">Fatura Atual</div><div class="cc-value">' + self.formatCurrency(total) + '</div></div><div style="text-align:right;"><div class="cc-label">Disponível</div><div class="cc-value">' + self.formatCurrency(available) + '</div></div></div>'; html += '<div style="position:absolute; bottom:0; left:0; right:0; height:4px; background:rgba(0,0,0,0.3);"><div style="height:100%; width:' + usedPct + '%; background:' + (usedPct > 80 ? '#ef4444' : usedPct > 50 ? '#f59e0b' : '#10b981') + ';"></div></div>'; html += '</div>'; }); html += '</div>'; container.innerHTML = html; }
...
openInvoice(cardId, offset = 0) {
    ...
    // Calcular data de referência baseada no offset
    ...
    if (daysUntilDue < 0) {
        dueClass = 'overdue';
        dueText += ' (Vencida há ' + Math.abs(daysUntilDue) + ' dias)';
    } else if (daysUntilDue === 0) {
        dueClass = 'overdue';
        dueText += ' (Vence hoje!)';
    } else if (daysUntilDue <= 3) {
        dueText += ' (Em ' + daysUntilDue + ' dias)';
    }
    ...
    html += '<div class="invoice-period-info">';
    html += '<div class="invoice-period-label"> Período da Fatura</div>';
    html += '<div class="invoice-period-value">' + this.formatDate(period.startDate.toISOString().split('T')[0]) + ' até ' + this.formatDate(period.closingDate.toISOString().split('T')[0]) + '</div>';
    html += '</div>';
    html += '<div class="invoice-due-info">';
    html += '<div class="invoice-due-label">💳 Vencimento</div>';
    html += '<div class="invoice-due-value ' + dueClass + '">' + dueText + '</div>';
    html += '</div>';
    html += '</div>';
...
navigateInvoice(direction) {
    ...
    // Contas a vencer (pendentes nos próximos 3 dias)
    ...
    // Alertas de fechamento de fatura (amanhã)
    const closingAlerts = [];
    ...
    if (closingAlerts.length > 0) {
        ...
        closingAlerts.forEach(alert => {
            ...
            html += '<div class="bill-desc">💳 ' + self.escapeHtml(alert.message) + '</div>';
            html += '<div class="bill-meta"><span>📅 Fechamento: ' + self.formatDate(alert.closingDate.toISOString().split('T')[0]) + '</span></div>';
            html += '</div>';
            html += '<div style="display:flex; gap:4px;">';
            html += '<button class="btn btn-secondary btn-small" onclick="openCreditCardsModal(); closeBillsModal();">Ver Cartão</button>';
            html += '</div></div>';
        });
        html += '</div>';
    }
    ...
    container.innerHTML = html;
        ...
        saveTransfer() {
            ...
            if (fromId === toId) { this.showToast('As contas devem ser diferentes'); return; }
            ...
            if (fromAcc.balance < amount) { this.showToast('Saldo insuficiente na conta de origem'); return; }
            ...
            this.transactions.push({ id: this.generateUniqueId(), date: date, amount: amount, category: 'resgate', description: description + ' (entrada)', statusOk: true, paymentMethod: 'transfer', accountId: toId });
            this.clearCache();
        ...
        initSwipeGestures() {
            ...
            document.addEventListener('touchend', function(e) {
                ...
                const transactionId = currentRow.dataset.id;
                if (Math.abs(diff) > 80 && transactionId) {
                    if (diff < -80) {
                        self.completeTransaction(transactionId, currentRow);
                    } else if (diff > 80) {
                        self.deleteTransactionSwipe(transactionId, currentRow);
                    }
                } else {
                    currentRow.classList.remove('swiping-right', 'swiping-left');
                }
        ...
        completeTransaction(id, row) {
            const transaction = this.transactions.find(t => String(t.id) === String(id));
            if (transaction) {
                transaction.statusOk = true;
                this.clearCache();
                this.saveTransactions();
                this.render();
                this.updateAlertBadge();
        ...
        renderCategoryBudget() {
            ...
            let html = '<div style="margin-bottom: 20px; padding: 16px; background: var(--glass-bg); border-radius: 14px;">';
            html += '<p style="font-size: 0.9rem; color: var(--text-secondary); margin: 0;"> Comparativo com a média dos últimos 3 meses</p></div>';
            let html2 = '<div>';
            ...
            sortedCategories.forEach(catId => {
                ...
                html2 += '<div class="category-budget-header">';
                html2 += '<div class="category-budget-name">';
                html2 += '<span style="width: 12px; height: 12px; background: ' + category.color + '; border-radius: 50%; display: inline-block;"></span>';
                html2 += self.escapeHtml(category.name);
                html2 += '</div>';
                html2 += '<div class="category-budget-amount">' + self.formatCurrency(currentAmount) + '</div>';
                html2 += '</div>';
                html2 += '<div class="category-budget-bar">';
                html2 += '<div class="category-budget-progress ' + barClass + '" style="width: ' + Math.min(percentage, 100) + '%"></div>';
                html2 += '</div>';
                html2 += '<div class="category-budget-info">';
                html2 += '<span>' + percentage.toFixed(0) + '% da média</span>';
                html2 += '<span>Média: ' + self.formatCurrency(averageAmount) + '</span>';
                html2 += '</div>';
                if (averageAmount > 0) {
                    const diff = currentAmount - averageAmount;
                    const diffText = diff > 0 ? '+' + self.formatCurrency(diff) : self.formatCurrency(diff);
                    html2 += '<div class="category-budget-average" style="color: ' + (diff > 0 ? 'var(--danger-color)' : 'var(--success-color)') + ';">';
                    html2 += (diff > 0 ? '⬆️' : '️') + ' ' + diffText + ' vs média';
                    html2 += '</div>';
                }
                html2 += '</div>';
            });
            ...
            if (Object.keys(categoryTotals).length === 0) {
                html2 = '<div style="text-align: center; padding: 40px; color: var(--text-secondary);"><div style="font-size: 3rem; margin-bottom: 16px; opacity: 0.5;"></div><h3>Nenhuma despesa este mês</h3><p>Adicione transações para ver o acompanhamento por categoria.</p></div>';
            }
...
window.openManualFromWhatsNew = function() {
    ...
    window.openCategoryBudgetModal = function() { smartwallet.renderCategoryBudget(); document.getElementById('categoryBudgetModal').classList.add('active'); document.getElementById('mainMenu').classList.remove('active'); };
    window.closeCategoryBudgetModal = function() { document.getElementById('categoryBudgetModal').classList.remove('active'); };
    ...
    window.openIncomeModal = function() {
        ...
        document.querySelectorAll('#transactionForm .type-btn').forEach(btn => {
            const isIncome = btn.getAttribute('data-type') === 'income';
            btn.classList.toggle('active', isIncome);
            btn.setAttribute('aria-checked', isIncome);
        });
        smartwallet.populateCategorySelects();
        smartwallet.populatePaymentMethodSelects();
        smartwallet.populateAccountSelects();
    ...
    window.closeTransferModal = function() { document.getElementById('transferModal').classList.remove('active'); };
